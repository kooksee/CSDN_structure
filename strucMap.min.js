function loadMap(t, e, r) {
    ...
    p.append("circle").attr({r: 29, class: "ring"}), p.append("circle").attr({
        r: 25,
        class: "outline"
    }).style({
        fill: function (t) {
        ...
        return t.prop.nTxt
    }).style({fill: "black"}), p.append("text").attr("class", "propName").text(function (t) {
        return t.prop.name
    }).style({fill: "black", "font-family": "SimSun"}), u.start();
